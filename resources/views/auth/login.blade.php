        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
                ...
                <form method="POST" action="/login" class="space-y-5">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 text-white font-semibold py-4 rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
                        Masuk
                    </button>
                </form>

                <div class="mt-6 text-center">
                    <p class="text-sm text-slate-500">Belum punya akun? <a href="/register"
                            class="text-blue-600 font-semibold hover:underline">Daftar sekarang</a></p>
                </div>
            </div>
