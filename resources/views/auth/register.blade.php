...
@section('content')
    <div
        class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center px-4 py-20">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="cursor-pointer">
                            ...
                            <div
                                class="peer-checked:border-blue-500 peer-checked:bg-blue-50 border-2 border-slate-200 rounded-xl p-4 text-center transition-all">
                ...
                <form method="POST" action="/register" class="space-y-4" id="registerForm">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="08xx-xxxx-xxxx"
                            required
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-50 outline-none transition-all text-sm">
                    </div>
                    ...
                    <div id="jastiperFields" class="hidden space-y-4">
                        <div>
                            ...
                            <input type="text" name="area_layanan" value="{{ old('area_layanan') }}"
                    ...
                    <div class="flex items-start gap-3 pt-2">
                        ...
                        <label for="agree" class="text-xs text-slate-500 cursor-pointer">
                            ...
                            dan <a href="#" class="text-blue-600 hover:underline">kebijakan privasi</a> JastipKu.
                        </label>
                    </div>

                    <button type="submit"
                        class="w-full bg-blue-600 text-white font-semibold py-4 rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 mt-2">
                        Buat Akun
                    </button>
                </form>

                <div class="mt-6 text-center">
                    <p class="text-sm text-slate-500">Sudah punya akun? <a href="/login"
