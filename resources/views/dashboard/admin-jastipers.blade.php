        ...
        <div class="flex">
            ...
            <main class="flex-1 lg:ml-64 p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-white border border-slate-200 rounded-2xl p-6">
                            ...
                            <div class="space-y-2 text-sm mb-4">
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="text-slate-800 font-medium text-right max-w-[60%]">{{ $jastiper->area_layanan ?? '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-yellow-500 font-semibold">★
                                        {{ number_format($jastiper->rating, 1) }}</span>
                                </div>
                                <div class="flex justify-between">
                            ...
                            <div class="flex gap-2 pt-4 border-t border-slate-100">
                                <form method="POST" action="/dashboard/admin/jastipers/{{ $jastiper->id }}/toggle"
                                    class="flex-1">
                                    @csrf @method('PATCH')
                                    <button type="submit"
                    ...
                    @empty
                        <div
                            class="col-span-3 bg-white rounded-2xl border border-slate-200 p-12 text-center text-slate-400">
