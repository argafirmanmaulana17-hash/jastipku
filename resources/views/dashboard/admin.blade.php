        ...
        <div class="flex">
            ...
            <main class="flex-1 lg:ml-64 p-6 lg:p-8">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    @foreach ([['label' => 'Total Order', 'value' => $stats['total_orders'] ?? '0', 'icon' => '📦', 'change' => '+12%'], ['label' => 'Order Hari Ini', 'value' => $stats['today_orders'] ?? '0', 'icon' => '📅', 'change' => '+5'], ['label' => 'Jastiper Aktif', 'value' => $stats['active_jastipers'] ?? '0', 'icon' => '🛵', 'change' => 'Online'], ['label' => 'Total Pendapatan', 'value' => 'Rp ' . number_format($stats['total_revenue'] ?? 0, 0, ',', '.'), 'icon' => '💰', 'change' => '+20%']] as $stat)
                        <div class="stat-card">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <a href="{{ route('dashboard.admin.jastiper-bills') }}"
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <select name="status" onchange="this.form.submit()"
                                                        ...
                                                        <option value="menunggu_harga"
                                                            {{ $order->status == 'menunggu_harga' ? 'selected' : '' }}>
                                                            Menunggu Harga</option>
                                                        <option value="menunggu_persetujuan"
                                                            {{ $order->status == 'menunggu_persetujuan' ? 'selected' : '' }}>
                                                            Menunggu Persetujuan</option>
                                                        <option value="proses"
                                                            {{ $order->status == 'proses' ? 'selected' : '' }}>Proses
                                                        </option>
                                                        <option value="otw"
                                                            {{ $order->status == 'otw' ? 'selected' : '' }}>OTW</option>
                        ...
                        @forelse($activeJastipers ?? [] as $jastiper)
                            <div class="flex items-center justify-between px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 font-bold">
