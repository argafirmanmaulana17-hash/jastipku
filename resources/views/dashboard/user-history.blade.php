    ...
    <div class="pt-24 pb-20 bg-slate-50 min-h-screen">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
                <div
                    class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @elseif($order->status == 'menunggu_harga')
                                                <span
                                                    class="px-3 py-1 rounded-full text-xs font-semibold bg-orange-50 text-orange-700 border border-orange-100">
                                                    Menunggu Harga
                                                </span>
                                            @elseif($order->status == 'menunggu_persetujuan')
                                                <span
                                                    class="px-3 py-1 rounded-full text-xs font-semibold bg-yellow-50 text-yellow-700 border border-yellow-100">
                                            ...
                                            @elseif($order->status == 'otw')
                                                <span
                                                    class="px-3 py-1 rounded-full text-xs font-semibold bg-purple-50 text-purple-700 border border-purple-100">
                                                    Diantar
                                                </span>
                                            ...
                                            @else
                                                <span
                                                    class="px-3 py-1 rounded-full text-xs font-semibold bg-rose-50 text-rose-700 border border-rose-100">
                                                    Batal
                                                </span>
                                            @endif
                                        </td>
