...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="animate-fadeInUp">
                    <div
                        class="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-6">
                    ...
                    <p class="text-lg text-slate-500 leading-relaxed mb-8 max-w-lg">
                        Layanan jasa titip terpercaya di lingkungan kampus. Mau jajan, beli alat tulis, atau apapun —
                        tinggal order, kami yang urus!
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="order"
                            class="inline-flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold px-8 py-4 rounded-2xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-200 hover:shadow-blue-300 hover:-translate-y-1">
                        ...
                        <a href="/tracking"
                            class="inline-flex items-center justify-center gap-2 bg-white text-slate-700 font-semibold px-8 py-4 rounded-2xl hover:bg-slate-50 transition-all border border-slate-200 hover:border-blue-300">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="hidden lg:flex justify-center">
                    <div class="relative animate-float">
                        <div
                            class="w-80 h-80 bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl shadow-2xl shadow-blue-300 flex items-center justify-center">
                            <svg class="w-40 h-40 text-white opacity-90" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-slate-500 mt-3 max-w-md mx-auto">Tidak perlu ribet, cukup ikuti langkah berikut dan barangmu
                    akan segera sampai!</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach ([['step' => '01', 'icon' => '📝', 'title' => 'Isi Form Order', 'desc' => 'Ceritakan apa yang mau kamu titip, dari mana, dan berapa budget kamu.'], ['step' => '02', 'icon' => '🛵', 'title' => 'Jastiper Berangkat', 'desc' => 'Jastiper kami yang ada di dekat lokasi akan menerima dan segera berangkat.'], ['step' => '03', 'icon' => '🎉', 'title' => 'Barang Sampai!', 'desc' => 'Barang diantarkan langsung ke kamu. Bayar setelah barang di tangan!']] as $item)
                    <div class="text-center card-hover bg-slate-50 rounded-2xl p-8">
                        <div
                            class="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4 shadow-lg shadow-blue-200">
                            {{ $item['icon'] }}
                        </div>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                @foreach ([['icon' => '🍔', 'title' => 'Makanan & Minuman', 'color' => 'bg-orange-50 border-orange-200'], ['icon' => '📚', 'title' => 'Alat Tulis & Buku', 'color' => 'bg-blue-50 border-blue-200'], ['icon' => '💊', 'title' => 'Obat & Kesehatan', 'color' => 'bg-green-50 border-green-200'], ['icon' => '👕', 'title' => 'Fashion & Outfit', 'color' => 'bg-purple-50 border-purple-200'], ['icon' => '💻', 'title' => 'Elektronik & Aksesoris', 'color' => 'bg-slate-50 border-slate-200'], ['icon' => '🛒', 'title' => 'Belanja Minimarket', 'color' => 'bg-yellow-50 border-yellow-200'], ['icon' => '🎁', 'title' => 'Kado & Hadiah', 'color' => 'bg-pink-50 border-pink-200'], ['icon' => '✨', 'title' => 'Dan Lainnya...', 'color' => 'bg-indigo-50 border-indigo-200']] as $service)
                    ...
                    <div class="card-hover bg-white border border-slate-200 rounded-2xl p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-lg">
                            ...
                            <span
                                class="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1 rounded-full bg-green-100 text-green-700">
                        ...
                        <div class="flex gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-yellow-500">★ {{ number_format($jastiper->rating, 1) }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach ([['name' => 'Dina F.', 'prodi' => 'Teknik Informatika', 'text' => 'Keren banget! Lagi ngerjain tugas tapi laper, tinggal order lewat JastipKu, 15 menit langsung dateng. Recommended!', 'rating' => 5], ['name' => 'Reza M.', 'prodi' => 'Manajemen', 'text' => 'Udah langganan dari semester 1. Jastipernya ramah-ramah dan barang selalu sesuai pesanan. Harga juga transparan!', 'rating' => 5], ['name' => 'Ayu P.', 'prodi' => 'Akuntansi', 'text' => 'Sistem trackingnya mantep, bisa tau posisi jastiper kita lagi di mana. Nggak perlu nanya-nanya terus!', 'rating' => 5]] as $testi)
    ...
    <section class="py-20 bg-gradient-to-br from-blue-600 to-blue-800">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/order"
                    class="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-bold px-10 py-4 rounded-2xl hover:bg-blue-50 transition-all shadow-xl">
                    Pesan Jastip Sekarang
                </a>
                <a href="/register"
                    class="inline-flex items-center justify-center gap-2 bg-blue-500/30 text-white font-semibold px-10 py-4 rounded-2xl hover:bg-blue-500/50 transition-all border border-blue-400">
